...
<section class="settings-card embed-page">
    ...
    <div class="preview-frame-wrap large">
        <iframe src="widget-preview.php?id=<?= (int) $widget['id'] ?>" title="<?= e(t('embed.preview_title')) ?>" class="preview-frame"></iframe>
    </div>

    <div class="form-actions">
        <a class="btn btn-light" href="admin-client-detail.php?id=<?= (int) $widget['user_id'] ?>"><?= e(t('button.back_to_client')) ?></a>
        <a class="btn btn-primary-soft" href="edit-widget.php?id=<?= (int) $widget['id'] ?>"><?= e(t('button.edit_settings')) ?></a>
    </div>
</section>
